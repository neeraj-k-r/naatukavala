  ...
  return (
    <form onSubmit={onSubmit} className="mt-3 flex flex-wrap items-center gap-2">
      ...
      <input
        ...
        className="min-w-0 flex-1 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-800 outline-none focus:border-emerald-500 disabled:opacity-60"
      />
      <button
        type="submit"
